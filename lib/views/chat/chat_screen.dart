...
import 'package:e_learning_application/views/chat/widgets/message_bubble.dart';
import 'package:e_learning_application/views/chat/widgets/message_input.dart';
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            MessageInput(controller: _messageController, onSendPressed: () {
